...
$pro = new Product;
$Products = $pro->read()->fetch_all(MYSQLI_ASSOC);

$orders = $pro->getProductbyorder()->fetch_all(MYSQLI_ASSOC);
...
<div class="product-area gray-bg pt-90 pb-65">
    <div class="container">
        <div class="product-top-bar section-border mb-55">
            <div class="section-title-wrap text-center">
                <h3 class="section-title">most ordered prodacts</h3>
            </div>
        </div>
        <div class="tab-content jump">
            <div class="tab-pane active">
                        ...
                        <?php foreach($orders AS $order) { ?>
                            <div class="product-img">
                                <a href="product-details.php?product=<?= $order['id'] ?>">
                                    <img alt="" src="assets/img/product/<?= $order['image'] ?>">
                                </a>
                                </div>
                                <div class="product-action">
                                    <a class="action-wishlist" href="#" title="Wishlist">
